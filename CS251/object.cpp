...
Object::Object(Shape* _shape, const int _objectId, const vec3 _diffuseColor, const vec3 _specularColor, const float _shininess , unsigned int _textureId)
	: diffuseColor(_diffuseColor), specularColor(_specularColor), shininess(_shininess), shape(_shape), objectId(_objectId), Light{ vec3(3, 3, 3) }, Ambient{ vec3(0.03, 0.03, 0.03) }, textureId{ _textureId }
{
